...
public abstract class MicroService implements Runnable {
    ...
    protected final <T, E extends Event<T>> void subscribeEvent(Class<E> type, Callback<E> callback) {
        ...
        call.put(type,callback);
        MessageBusImpl.getMessageBusImpl().subscribeEvent(type,this);
    }
    ...
    call.put(type,callback);
    MessageBusImpl.getMessageBusImpl().subscribeBroadcast(type,this);
    }
    ...
    protected final <T> Future<T> sendEvent(Event<T> e) {
        ...
        try {
            ...
            System.out.println("exception in microservice "+ e.toString() );
        }
    ...
    protected final void sendBroadcast(Broadcast b) {
            MessageBusImpl.getMessageBusImpl().sendBroadcast(b);
    }
